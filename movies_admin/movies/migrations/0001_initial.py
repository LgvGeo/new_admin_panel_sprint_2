# Generated by Django 3.2 on 2023-09-17 13:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.FloatField(validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='rating')),
                ('type', models.CharField(choices=[('movie', 'movie'), ('tv_show', 'tv show')], max_length=32, verbose_name='type')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['genre', 'film_work'], name='genre_film__genre_i_e7718a_idx'),
        ),
